...
exports.fromfile = exports.history = exports.video = exports.getVideoMeta = exports.signUrl = exports.getUserProfileInfo = exports.getHashtagInfo = exports.trendEvent = exports.musicEvent = exports.userEvent = exports.hashtagEvent = exports.music = exports.trend = exports.user = exports.hashtag = void 0;
...
const randomUserAgent = () => `Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${Math.floor(Math.random() * 4) +
...
const promiseScraper = async (input, type, options = {}) => {
    ...
    options.sign = helpers_1.sign(options.userAgent);
